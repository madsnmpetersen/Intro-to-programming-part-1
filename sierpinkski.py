...
height1=1000
width1=1500
w = FractalWorld(width=width1,height=height1,delay=0) #creates our world, with some arguments for height, width and delay
f = Fractal(draw=False) #creates a Fractal, which is the same as a turtle in turtleworld, except here itself isn't drawn.
